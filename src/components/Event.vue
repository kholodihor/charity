<template>
  <section class="events">
    ...
    <div class="box">
      ...
      <template v-if="true">
        <div class="container">
          <div class="card" :class="{ done: event.booked }" v-for="(event, id) in eventStore.events" :key="id"
            data-test="event">
            <div class="date">
            ...
            <div class="buttons">
              <button class="book" aria-label="Book Your Table" @click="updateEvent(event.id), (event.booked = true)"
                v-if="!event.booked">
                Book Your Table
              </button>
              <button class="cancel" aria-label=" Cancel Booking" @click.prevent="event.booked = false" v-else>
                Cancel Booking
              </button>
              <button class="remove" aria-label="Remove Event" @click.prevent="deleteEvent(event.id)">
                Remove
              </button>
            </div>
          </div>
