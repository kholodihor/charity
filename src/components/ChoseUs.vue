<template>
  <div class="container">
    <span class="subtitle"><i class="far fa-heart"></i>Why Choose Us</span>
      ...
      <div class="left">
        <div class="card" data-test="card">
          ...
          <div class="card-main">
            ...
            <p>
              Charity is the largest global for crowdfunding community with connecting nonprofits
            </p>
          </div>
        </div>
        <div class="card" data-test="card">
  ...
  .box {
    ...
    .right {
      ...
      .donation-box {
        ...
        flex-wrap: wrap;
        background: url(/img/c-image.webp) no-repeat;
